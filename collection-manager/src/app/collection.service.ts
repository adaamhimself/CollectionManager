...
export class CollectionService {
  ...
  getCollectionByUserId(id: CollectionId): Observable<any> { 
    return this.http.get<any>(`${environment.apiBaseUrl}/collection/getCollectionByUserId/${id}`, "collection_id": `${id }`);
  }
  ...
  removeCollection(id: CollectionId): Observable<any> { 
    return this.http.delete<any>(`${environment.apiBaseUrl}/collection/removeCollection/${id}`, id);
  } 
}
